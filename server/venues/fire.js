module.exports = (document) => {
	...
	eventHolders = Array.from(eventHolders).map(eventHolder => {
		...
		const link = eventHolder.querySelector('.url').getAttribute('href');
		// link = whats-on/London/Fire/Beyond/35848218/
		https://www.skiddle.com/whats-on/London/Fire/Beyond/35848218/
